...
-- Dumping database structure for redm
CREATE DATABASE IF NOT EXISTS `redm` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci */;
USE `redm`;

-- Dumping structure for table redm.community_users
CREATE TABLE IF NOT EXISTS `community_users` (
  ...
  `tunnid` bigint(20) DEFAULT NULL,
  `hours` bigint(20) DEFAULT NULL,
  `wlstatus` int(11) NOT NULL DEFAULT 0,
